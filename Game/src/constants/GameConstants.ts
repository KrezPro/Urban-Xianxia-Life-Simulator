export const GameConstants = {
  ...
  NOTIFICATION_DEFAULT_DURATION_MS: 6000,
  NOTIFICATION_MAX_VISIBLE: 2,
  NOTIFICATION_MAX_QUEUE: 12,
  NOTIFICATION_ANIMATION_IN_MS: 220,
  NOTIFICATION_ANIMATION_OUT_MS: 180,
};